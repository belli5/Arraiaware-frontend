...
import EvaluationsPanelBrutalFact from '../components/BrutalFact/EvolutionPanelBrutalFact';
            ...
            {activeTab === 'brutalfact' && (
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                {selectedEval ? (
                  ...
                  projectName={selectedEval.projectName}    // ← aqui
                  cycleName={selectedEval.cycleName}        // ← e aqui
                  onViewDetails={() => setSelectedEval(null)}
                  onCreateActionPlan={() => { /*…*/ }}
                />
                ) : (
                  /* Senão mostra a tabela normal */
                  <>
